...
import { extractJSStrings } from '../utils/stringExtractor';
import { shouldExclude } from '../utils/excludeMethods';
import { toLocale, toLabel } from '../utils/utils';

export function refreshJSTSDiagnostics(doc: vscode.TextDocument, collection: vscode.DiagnosticCollection) {
    ...
    const matches = extractJSStrings(doc);
